...
# 1. Set the usual env vars, minus anything eMMC-related. `.env_nano` (untracked, local to this
#    checkout) already has these filled in for this machine — source it instead of exporting by hand:
source .env_nano
# .env_nano contains:
